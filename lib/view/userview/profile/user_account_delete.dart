...
class UserAccountDeletePage extends StatefulWidget {
  const UserAccountDeletePage({super.key});

  @override
  State<UserAccountDeletePage> createState() => _UserAccountDeletePageState();
}

class _UserAccountDeletePageState extends State<UserAccountDeletePage> {
