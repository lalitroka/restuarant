...
class AdminFoodItemPage extends StatefulWidget {
  const AdminFoodItemPage({super.key});

  @override
  State<AdminFoodItemPage> createState() => _FoodAddPageState();
}

class _FoodAddPageState extends State<AdminFoodItemPage>  {
              ...
              children: [
                Row(
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: () {
                        Navigator.pushNamed(context, '/adminfoodviewpage');
                      },
                      label: Text(
                        'View',
                        style: GoogleFonts.poppins(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  AnimatedSize(
                                    ...
                                    curve: Curves.linear,
                                    child: BlocBuilder<FoodItemBloc, FoodItemState>(
